...
- `GAPS.md` now contains only intentionally retired legacy-only methods plus non-gap reviewer notes.
...
- Current retired-method and non-gap summary is tracked in [GAPS.md](GAPS.md).
